...
- KNUCKLE SANDWICH - Be outside of circles correlating to the number of windups of Prishe's fist
  - Donut of opposite size follows
- AURORAL UPPERCUT - Knockback, distance set by number of windups. Aim to not land on needles or off-arena
...
- TT does a slash (GUILLOTINE), otherwise MT and GK just dodge stuff
  - There is a nasty donut after a spam of cone AoEs, look for it
- EV and HM:
  - Run when tethered
